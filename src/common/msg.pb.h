...
constexpr DeliveryMode DeliveryMode_MIN = UNDURABLE;
...
class MessagePayload final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR MessagePayload(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  MessagePayload(const MessagePayload& from);
  MessagePayload(MessagePayload&& from) noexcept
    : MessagePayload() {
    *this = ::std::move(from);
  }

  inline MessagePayload& operator=(const MessagePayload& from) {
    CopyFrom(from);
    return *this;
  }
  inline MessagePayload& operator=(MessagePayload&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const MessagePayload& default_instance() {
    return *internal_default_instance();
  }
  ...
  friend void swap(MessagePayload& a, MessagePayload& b) {
    a.Swap(&b);
  }
  inline void Swap(MessagePayload* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(MessagePayload* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  MessagePayload* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MessagePayload>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const MessagePayload& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const MessagePayload& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
...
inline bool MessagePayload::has_properties() const {
  return _internal_has_properties();
}
inline void MessagePayload::clear_properties() {
...
inline void MessagePayload::_internal_set_body(const std::string& value) {
  
  body_.Set(value, GetArenaForAllocation());
}
inline std::string* MessagePayload::_internal_mutable_body() {
...
// string valid = 3;
inline void MessagePayload::clear_valid() {
  valid_.ClearToEmpty();
}
...
inline void MessagePayload::_internal_set_valid(const std::string& value) {
  
  valid_.Set(value, GetArenaForAllocation());
}
inline std::string* MessagePayload::_internal_mutable_valid() {
...
inline uint64_t Message::_internal_offset() const {
  return offset_;
}
...
inline uint64_t Message::_internal_length() const {
  return length_;
}
